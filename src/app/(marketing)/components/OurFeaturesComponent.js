const OurFeaturesComponent = () => {
  return (
    <div className="container-fluid feature pb-5" style={{ background: "rgba(248,187,208,0.04)" }}>
      <div className="container pb-5">
        <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style={{ maxWidth: "800px" }}>
          <h4 className="text-uppercase" style={{ color: "#ff5c95ff" }}>Dịch Vụ Nổi Bật</h4>
        ...
        <div className="row g-3">
          <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
            <div className="feature-item p-4 rounded-4 shadow-sm" style={{ background: '#fff' }}>
              <div className="feature-icon p-4 mb-4">
                <i className="fas fa-bolt fa-4x" style={{ color: "#ff5c95ff" }}></i>
              </div>
          ...
          <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
            <div className="feature-item p-4 rounded-4 shadow-sm" style={{ background: '#fff' }}>
              <div className="feature-icon p-4 mb-4">
                <i className="fas fa-users fa-4x" style={{ color: "#ff5c95ff" }}></i>
              </div>
          ...
          <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
            <div className="feature-item p-4 rounded-4 shadow-sm" style={{ background: '#fff' }}>
              <div className="feature-icon p-4 mb-4">
                <i className="fas fa-gem fa-4x" style={{ color: "#ff5c95ff" }}></i>
              </div>
          ...
          <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
            <div className="feature-item p-4 rounded-4 shadow-sm" style={{ background: '#fff' }}>
              <div className="feature-icon p-4 mb-4">
                <i className="fas fa-receipt fa-4x" style={{ color: "#ff5c95ff" }}></i>
              </div>
              <h4>Giá Minh Bạch</h4>
